...
export default function CourseDetail() {
  ...
  const handleEnroll = async () => {
    ...
    setEnrolling(true);
    try {
      // (Aquí iría la lógica de pago si es un curso virtual)
      // Por ahora, lo inscribimos directamente (simulando pago)
      await api.post(`/api/courses/${id}/inscribirme`);
      setIsEnrolled(true);
      
      // Si es virtual, lo llevamos al visor
      if (curso.modalidad === 'virtual') {
         navigate(`/mis-cursos/${id}/ver`);
      } else {
         // Si es presencial, mostramos mensaje de éxito
         alert('¡Inscripción exitosa! Revisa "Mis Cursos" para ver tu registro.');
         navigate('/mis-cursos');
      }
            ...
            <div className="course-content-list">
             ...
             <div className="course-content-list">
                <div className="course-content-item">
                   ...
                   <div className="course-content-item__title">
                     <strong>Fecha:</strong> {new Date(curso.fecha_inicio_presencial).toLocaleDateString('es-ES', { timeZone: 'UTC' })}
                   </div>
                </div>
                <div className="course-content-item">
        ...
        <aside className="course-detail-sidebar">
          <div className="course-buy-box">
            ...
            <div className="course-buy-box__meta">
              ...
              <div className="meta-item">
                <Users size={16} />
                <span>{isVirtual ? 'Acceso individual' : `${curso.cupos_totales || 'N/A'} cupos`}</span>
              </div>
            </div>
          </div>
        </aside>
